...
<head>
    <form action="meenties1.php" method="post" enctype="multipart/form-data">
        ...
        <section class="table__body">
            <table>
                ...
                <tbody>
                    ...
                    <td>1</td>
                    <td>
                    <?php display_image('meentiesname','meenties1201','image1');?>    
</td>
...
<?php
  upload('jairam','image1','filedownload','filename','file_name');
  view_count('jairam','filedownload','filename');
?>
</td>
<td><div class="file-input">
  ...
  <span class="file-input-name" id="file_workshop">No file selected</span>
        ...
        upload('jairam','image2','fileworkshop','workshop','file_workshop');
        view_count('jairam','fileworkshop','workshop');
?>
        </td>
        <td><div class="file-input">
  ...
  <span class="file-input-name" id="file_paper">No file selected</span>
    ...
    <?php
    upload('jairam','image3','filepaper','paper','file_paper');
    view_count('jairam','filepaper','paper');
    ?>
  ...
  <span class="file-input-name" id="file_sports">No file selected</span>
   ...
   upload('jairam','image4','filesports','sports','file_sports');
   view_count('jairam','filesports','sports');
?></td>
    <td><button type="submit" name="submit" class="btn btn-primary"> <strong> Upload </strong> </button></td>
    </tr>
    <td>2</td>
    
<td><?php display_image('meentiesname','meenties1201','image2');?>
</td>
<td><?php details('meentiesname','meenties1201','name2','name2');?></td>
 <td><?php details('meentiesname','meenties1201','cse2','cse2');?></td>
 <td><?php details('meentiesname','meenties1201','gender2','gender2');?></td>
        <td><div class="file-input">
...
upload('hari','pic1','filedownload','filename','file_intern');
view_count('hari','filedownload','filename');
?>
    </td>
  <td><div class="file-input">
...
upload('hari','pic2','fileworkshop','workshop','file_workshop1');
view_count('hari','fileworkshop','workshop');
...
upload('hari','pic3','filepaper','paper','file_paper1');
view_count('hari','filepaper','paper');
 ...
 <span class="file-input-name" id="file_sports1">No file selected</span>
  ...
  upload('hari','pic4','filesports','sports','file_sports1');
  view_count('hari','filesports','sports');
?></td>
 <td> <button type="submit" name="submit" class="btn btn-primary"> <strong> Upload </strong> </button> </td>
      ...
      <tr>
        ...
        <td><?php display_image('meentiesname','meenties1201','image3');?></td>
 <td><?php details('meentiesname','meenties1201','name3','name3');?></td>
 <td><?php details('meentiesname','meenties1201','cse3','cse3');?></td>
 <td><?php details('meentiesname','meenties1201','gender3','gender3');?></td>
        <td><div class="file-input">
  ...
  <span class="file-input-name" id="file_name2">No file selected</span>
        ...
        <?php
        upload('example', 'file1', 'filedownload', 'filename','file_name2');
        view_count('example', 'filedownload', 'filename');
        ?>
  ...
  <span class="file-input-name" id="file_workshop2">No file selected</span>
        ...
        <?php
        upload('example','file2','fileworkshop','Workshop','file_workshop2');
        view_count('example','fileworkshop','Workshop');
        ?>
  ...
  <span class="file-input-name" id="file_paper2">No file selected</span>
        ...
        <?php
        upload('example','file3','filepaper','paper','file_paper2');
        view_count('example','filepaper','paper');
  ...
  <span class="file-input-name" id="file_sports2">No file selected</span>
   ...
   upload('example','file4','filesports','sports','file_sports2');
   view_count('example','filesports','sports');
?></td>
        <td> <button  type="submit" name="submit" class="btn btn-primary"> <strong> Upload </strong> </button></td>
      ...
      <tr>
      <td>4</td>
      <td><?php display_image('meentiesname','meenties1201','image4');?>                                                           </td>
 <td><?php details('meentiesname','meenties1201','name4','name4');?></td>
 <td><?php details('meentiesname','meenties1201','cse4','cse4');?></td>
 <td><?php details('meentiesname','meenties1201','gender4','gender4');?></td>
        <td><div class="file-input">
  ...
  <span class="file-input-name" id="file_name3">No file selected</span>
        ...
        <?php
        upload('data4', 'use1', 'filedownload', 'filename','file_name3');
        view_count('data4', 'filedownload', 'filename');
        ?>
  ...
  <span class="file-input-name" id="file_workshop3">No file selected</span>
        ...
        <?php
        upload('data4','use2','fileworkshop','Workshop','file_workshop33');
        view_count('data4','fileworkshop','Workshop');
        ?>
  ...
  <span class="file-input-name" id="file_paper3">No file selected</span>
        ...
        <?php
        upload('data4','use3','filepaper','paper','file_paper3');
        view_count('data4','filepaper','paper');
        //generate_pie_chart('fileworkshop')
        ?>
  ...
  <span class="file-input-name" id="file_sports3">No file selected</span>
   ...
   upload('data4','use4','filesports','sports','file_sports3');
   view_count('data4','filesports','sports');
?></td>
        <td> <button  type="submit" name="submit" class="btn btn-primary"> <strong> Upload </strong> </button></td>
</tr>
<tr>
<td>5</td>
<td><?php display_image('meentiesname','meenties1201','image5');?></td>
 <td><?php details('meentiesname','meenties1201','name5','name5');?></td>
 <td><?php details('meentiesname','meenties1201','cse5','cse5');?></td>
 <td><?php details('meentiesname','meenties1201','gender5','gender5');?></td>
 <td><div class="file-input">
  ...
  <span class="file-input-name" id="file-name4">No file selected</span>
        ...
        <?php
        upload('data5', 'bb1', 'filedownload', 'filename','file_name4');
        view_count('data5', 'filedownload', 'filename');
        ?>
  ...
  <span class="file-input-name" id="file_workshop4">No file selected</span>
        ...
        <?php
        upload('data5','bb2','fileworkshop','Workshop','file_workshop4');
        view_count('data5','fileworkshop','Workshop');
        ?>
   </td>
  ...
  <span class="file-input-name" id="file_paper4">No file selected</span>
        ...
        <?php
        upload('data5','bb3','filepaper','paper','file_paper4');
        view_count('data5','filepaper','paper');
        ?>
  ...
  <span class="file-input-name" id="file_sports4">No file selected</span>
   ...
   upload('data5','bb4','filesports','sports','file_sports4');
   view_count('data5','filesports','sports');
?></td>
        <td> <button  type="submit" name="submit" class="btn btn-primary"> <strong> Upload </strong> </button></td>
      </tr>
<td>6</td>
<td><?php display_image('meentiesname','meenties10','image6');?></td>
 <td><?php details('meentiesname','meenties10','name6','name6');?></td>
 <td><?php details('meentiesname','meenties10','cse6','cse6');?></td>
 <td><?php details('meentiesname','meenties10','gender6','gender6');?></td>
        <td><div class="file-input">
  ...
  <span class="file-input-name" id="file-name5">No file selected</span>
        ...
        <?php
        upload('data6', 'b1', 'filedownload', 'filename','file_name5');
        view_count('data6', 'filedownload', 'filename');
        ?>
  ...
  <span class="file-input-name" id="file_workshop5">No file selected</span>
        ...
        <?php
        upload('data6','b2','fileworkshop','Workshop','file_workshop5');
        view_count('data6','fileworkshop','Workshop');
        ?>
   </td>
  ...
  <span class="file-input-name" id="file_paper5">No file selected</span>
        ...
        <?php
        upload('data6','b3','filepaper','paper','file_paper5');
        view_count('data6','filepaper','paper');
        ?>
  ...
  <span class="file-input-name" id="file_sports5">No file selected</span>
   ...
   upload('data6','b4','filesports','sports','file_sports5');
   view_count('data6','filesports','sports');
?></td>
        <td> <button  type="submit" name="submit" class="btn btn-primary"> <strong> Upload </strong> </button></td>
      </tr> <tr><td>7</td>
      <td><?php display_image('meentiesname','meenties10','image7');?></td>
 <td><?php details('meentiesname','meenties10','name7','name7');?></td>
 <td><?php details('meentiesname','meenties10','cse7','cse7');?></td>
 <td><?php details('meentiesname','meenties10','gender7','gender7');?></td>
        <td><div class="file-input">
  ...
  <span class="file-input-name" id="file-name6">No file selected</span>
        ...
        <?php
        upload('data7', 'c1', 'filedownload', 'filename','file_name6');
        view_count('data7', 'filedownload', 'filename');
        ?>
  ...
  <span class="file-input-name" id="file_workshop6">No file selected</span>
        ...
        <?php
        upload('data7','c2','fileworkshop','Workshop','file_workshop6');
        view_count('data7','fileworkshop','Workshop');
        ?>
   </td>
  ...
  <span class="file-input-name" id="file_paper6">No file selected</span>
        ...
        <?php
        upload('data7','c3','filepaper','paper','file_paper6');
        view_count('data7','filepaper','paper');
        ?>
  ...
  <span class="file-input-name" id="file_sports6">No file selected</span>
   ...
   upload('data7','c4','filesports','sports','file_sports5');
   view_count('data7','filesports','sports');
?></td>
        <td> <button  type="submit" name="submit" class="btn btn-primary"> <strong> Upload </strong> </button></td>
      </tr>
      <tr>
      <td>8</td>
      <td><?php display_image('meentiesname','meenties10','image8');?></td>
 <td><?php details('meentiesname','meenties10','name8','name8');?></td>
 <td><?php details('meentiesname','meenties10','cse8','cse8');?></td>
 <td><?php details('meentiesname','meenties10','gender8','gender8');?></td>
        <td><div class="file-input">
  ...
  <span class="file-input-name" id="file-name7">No file selected</span>
        ...
        <?php
        upload('data8', 'd1', 'filedownload', 'filename','file_name6');
        view_count('data8', 'filedownload', 'filename');
        ?>
  ...
  <span class="file-input-name" id="file_workshop7">No file selected</span>
        ...
        <?php
        upload('data8','d2','fileworkshop','Workshop','file_workshop6');
        view_count('data8','fileworkshop','Workshop');
        ?>
   </td>
  ...
  <span class="file-input-name" id="file_paper7">No file selected</span>
        ...
        <?php
        upload('data8','d3','filepaper','paper','file_paper7');
        view_count('data8','filepaper','paper');
        ?>
  ...
  <span class="file-input-name" id="file_sports7">No file selected</span>
   ...
   upload('data8','d4','filesports','sports','file_sports7');
   view_count('data8','filesports','sports');
?></td>
        <td> <button  type="submit" name="submit" class="btn btn-primary"> <strong> Upload </strong> </button></td>
      </tr><tr>
      <td>9</td>
      <td><?php display_image('meentiesname','meenties10','image9');?></td>
 <td><?php details('meentiesname','meenties10','name9','name9');?></td>
 <td><?php details('meentiesname','meenties10','cse9','cse9');?></td>
 <td><?php details('meentiesname','meenties10','gender9','gender9');?></td>
        <td><div class="file-input">
  ...
  <span class="file-input-name" id="file-name8">No file selected</span>
        ...
        <?php
        upload('data9', 'e1', 'filedownload', 'filename','file_name8');
        view_count('data9', 'filedownload', 'filename');
        ?>
  ...
  <span class="file-input-name" id="file_workshop8">No file selected</span>
        ...
        <?php
        upload('data9','e2','fileworkshop','Workshop','file_workshop8');
        view_count('data9','fileworkshop','Workshop');
        ?>
   </td>
  ...
  <span class="file-input-name" id="file_paper8">No file selected</span>
        ...
        <?php
        upload('data9','e3','filepaper','paper','file_paper8');
        view_count('data9','filepaper','paper');
        ?>
  ...
  <span class="file-input-name" id="file_sports8">No file selected</span>
   ...
   upload('data9','e4','filesports','sports','file_sports8');
   view_count('data9','filesports','sports');
?></td>
        <td> <button  type="submit" name="submit" class="btn btn-primary"> <strong> Upload </strong> </button></td>
      </tr><tr>
      <td>10</td>
      <td><?php display_image('meentiesname','meenties10','image10');?></td>
 <td><?php details('meentiesname','meenties10','name10','name10');?></td>
 <td><?php details('meentiesname','meenties10','cse10','cse10');?></td>
 <td><?php details('meentiesname','meenties10','gender10','gender10');?></td>
        <td><div class="file-input">
  ...
  <span class="file-input-name" id="file-name9">No file selected</span>
        ...
        <?php
        upload('data10', 'f1', 'filedownload', 'filename','file_name9');
        view_count('data10', 'filedownload', 'filename');
        ?>
  ...
  <span class="file-input-name" id="file_workshop9">No file selected</span>
        ...
        <?php
        upload('data10','f2','fileworkshop','Workshop','file_workshop9');
        view_count('data10','fileworkshop','Workshop');
        ?>
   </td>
  ...
  <span class="file-input-name" id="file_paper9">No file selected</span>
        ...
        <?php
        upload('data10','f3','filepaper','paper','file_paper9');
        view_count('data10','filepaper','paper');
        ?>
  ...
  <span class="file-input-name" id="file_sports9">No file selected</span>
   ...
   upload('data10','f4','filesports','sports','file_sports9');
   view_count('data10','filesports','sports');
?></td>
        <td> <button  type="submit" name="submit" class="btn btn-primary"> <strong> Upload </strong> </button></td>
      </tr>
      <tr>
        ...
        <td><?php display_image('meentiesname','meenties1115','image11');?>        
</td>

 <td><?php details('meentiesname','meenties1115','name11','name11');?></td>
 <td><?php details('meentiesname','meenties1115','cse11','cse11');?></td>
 <td><?php details('meentiesname','meenties1115','gender11','gender11');?></td>
 <td><div class="file-input">
...
<?php
  upload('data11','g1','filedownload','filename','file_name10');
  view_count('data11','filedownload','filename');
?>
</td>
<td><div class="file-input">
  ...
  <span class="file-input-name" id="file_workshop10">No file selected</span>
        ...
        upload('data11','g2','fileworkshop','workshop','file_workshop10');
        view_count('data11','fileworkshop','workshop');
?>
        </td>
        <td><div class="file-input">
  ...
  <span class="file-input-name" id="file_paper10">No file selected</span>
    ...
    <?php
    upload('data11','g3','filepaper','paper','file_paper10');
    view_count('data11','filepaper','paper');
    ?>
    </td><td>  <div class="file-input">
  ...
  <span class="file-input-name" id="file_sports10">No file selected</span>
   ...
   upload('data11','g4','filesports','sports','file_sports10');
   view_count('data11','filesports','sports');
?></td>
    <td><button type="submit" name="submit" class="btn btn-primary"> <strong> Upload </strong> </button></td>
    </tr>
    <tr>
      <td>12</td>
      <td><?php display_image('meentiesname','meenties1115','image12');?>
</td>
<td><?php details('meentiesname','meenties1115','name12','name12');?></td>
 <td><?php details('meentiesname','meenties1115','cse12','cse12');?></td>
 <td><?php details('meentiesname','meenties1115','gender12','gender12');?></td>
        <td><div class="file-input">
...
upload('data12','h1','filedownload','filename','file_intern11');
view_count('data12','filedownload','filename');
?>
    </td>
  <td><div class="file-input">
...
upload('data12','h2','fileworkshop','workshop','file_workshop11');
view_count('data12','fileworkshop','workshop');
...
upload('data12','h3','filepaper','paper','file_paper11');
view_count('data12','filepaper','paper');
 ...
 <span class="file-input-name" id="file_sports11">No file selected</span>
  ...
  upload('data12','h4','filesports','sports','file_sports11');
  view_count('data12','filesports','sports');
?></td>
 <td> <button type="submit" name="submit" class="btn btn-primary"> <strong> Upload </strong> </button> </td>
    </tr>
    <td>13</td>
    <td><?php display_image('meentiesname','meenties1115','image13');?></td>
 <td><?php details('meentiesname','meenties1115','name13','name13');?></td>
 <td><?php details('meentiesname','meenties1115','cse13','cse13');?></td>
 <td><?php details('meentiesname','meenties1115','gender13','gende13');?></td>
        <td><div class="file-input">
  ...
  <span class="file-input-name" id="file_name12">No file selected</span>
        ...
        <?php
        upload('data13', 'i1', 'filedownload', 'filename','file_name12');
        view_count('data13', 'filedownload', 'filename');
        ?>
  ...
  <span class="file-input-name" id="file_workshop12">No file selected</span>
        ...
        <?php
        upload('data13','i2','fileworkshop','Workshop','file_workshop12');
        view_count('data13','fileworkshop','Workshop');
        ?>
  ...
  <span class="file-input-name" id="file_paper12">No file selected</span>
        ...
        <?php
        upload('data13','i3','filepaper','paper','file_paper12');
        view_count('data13','filepaper','paper');
        //generate_pie_chart('fileworkshop')
        ?>
  ...
  <span class="file-input-name" id="file_sports12">No file selected</span>
   ...
   upload('data13','i4','filesports','sports','file_sports12');
   view_count('data13','filesports','sports');
?></td>
        <td> <button  type="submit" name="submit" class="btn btn-primary"> <strong> Upload </strong> </button></td>
        
      </tr>
      <tr>  <td>14</td>
      <td><?php display_image('meentiesname','meenties1115','image14');?></td>
 <td><?php details('meentiesname','meenties1115','name14','name14');?></td>
 <td><?php details('meentiesname','meenties1115','cse14','cse14');?></td>
 <td><?php details('meentiesname','meenties1115','gender14','gender14');?></td>
        <td><div class="file-input">
  ...
  <span class="file-input-name" id="file_name13">No file selected</span>
        ...
        <?php
        upload('data14', 'j1', 'filedownload', 'filename','file_name13');
        view_count('data14', 'filedownload', 'filename');
        ?>
  ...
  <span class="file-input-name" id="file_workshop13">No file selected</span>
        ...
        <?php
        upload('data14','j2','fileworkshop','Workshop','file_workshop13');
        view_count('data14','fileworkshop','Workshop');
        ?>
  ...
  <span class="file-input-name" id="file_paper13">No file selected</span>
        ...
        <?php
        upload('data14','j3','filepaper','paper','file_paper13');
        view_count('data14','filepaper','paper');
        //generate_pie_chart('fileworkshop')
        ?>
  ...
  <span class="file-input-name" id="file_sports13">No file selected</span>
   ...
   upload('data14','j4','filesports','sports','file_sports13');
   view_count('data14','filesports','sports');
?></td>
        <td> <button  type="submit" name="submit" class="btn btn-primary"> <strong> Upload </strong> </button></td>
</tr>

<td>15</td>
<td><?php display_image('meentiesname','meenties1115','image15');?></td>
 <td><?php details('meentiesname','meenties1115','name15','name15');?></td>
 <td><?php details('meentiesname','meenties1115','cse15','cse15');?></td>
 <td><?php details('meentiesname','meenties1115','gender15','gender15');?></td>
 ...
 <td><div class="file-input">
  ...
  <span class="file-input-name" id="file_workshop14">No file selected</span>
        ...
        <?php
        upload('data15','fileed1','filedownload','filename','file-name14');
        view_count('data15','filedownload','filename');
        ?>
  ...
  <span class="file-input-name" id="file_workshop14">No file selected</span>
        ...
        <?php
        upload('data15','fileed2','fileworkshop','Workshop','file_workshop14');
        view_count('data15','fileworkshop','Workshop');
        ?>
  ...
  <span class="file-input-name" id="file_paper14">No file selected</span>
        ...
        <?php
        upload('data15','fileed3','filepaper','paper','file_paper14');
        view_count('data15','filepaper','paper');
        //generate_pie_chart('fileworkshop')
        ?>
...
<?php
   ...
   upload('data15','fileed4','filesports','sports','file_sports14');
   view_count('data15','filesports','sports');
?>
</td>
    <td> <button  type="submit" name="submit" class="btn btn-primary"> <strong> Upload </strong> </button></td>
    </tr>
    ...
    <td>16</td>
    <td><?php display_image('meentiesname','meenties1620','image16');?></td>
 <td><?php details('meentiesname','meenties1620','name16','name16');?></td>
 <td><?php details('meentiesname','meenties1620','cse16','cse16');?></td>
 <td><?php details('meentiesname','meenties1620','gender16','gender16');?></td>
        <td><div class="file-input">
  ...
  <span class="file-input-name" id="file-name15">No file selected</span>
        ...
        <?php
        upload('data16', 'asd1', 'filedownload', 'filename','file_name15');
        view_count('data16', 'filedownload', 'filename');
        ?>
  ...
  <span class="file-input-name" id="file_workshop15">No file selected</span>
        ...
        <?php
        upload('data16','asd2','fileworkshop','Workshop','file_workshop15');
        view_count('data16','fileworkshop','Workshop');
        ?>
   </td>
  ...
  <span class="file-input-name" id="file_paper15">No file selected</span>
        ...
        <?php
        upload('data16','asd3','filepaper','paper','file_paper15');
        view_count('data16','filepaper','paper');
        ?>
  ...
  <span class="file-input-name" id="file_sports15">No file selected</span>
   ...
   upload('data16','asd4','filesports','sports','file_sports15');
   view_count('data16','filesports','sports');
?></td>
        <td> <button  type="submit" name="submit" class="btn btn-primary"> <strong> Upload </strong> </button></td></tr>
        <tr>
        <td>17</td>
        <td><?php display_image('meentiesname','meenties1620','image17');?></td>
 <td><?php details('meentiesname','meenties1620','name17','name17');?></td>
 <td><?php details('meentiesname','meenties1620','cse17','cse17');?></td>
 <td><?php details('meentiesname','meenties1620','gender17','gender17');?></td>
        <td><div class="file-input">
  ...
  <span class="file-input-name" id="file-name16">No file selected</span>
        ...
        <?php
        upload('data17', 'k1', 'filedownload', 'filename','file_name16');
        view_count('data17', 'filedownload', 'filename');
        ?>
  ...
  <span class="file-input-name" id="file_workshop16">No file selected</span>
        ...
        <?php
        upload('data17','k2','fileworkshop','Workshop','file_workshop16');
        view_count('data17','fileworkshop','Workshop');
        ?>
   </td>
  ...
  <span class="file-input-name" id="file_paper16">No file selected</span>
        ...
        <?php
        upload('data17','k3','filepaper','paper','file_paper16');
        view_count('data17','filepaper','paper');
        ?>
  ...
  <span class="file-input-name" id="file_sports16">No file selected</span>
   ...
   upload('data17','k4','filesports','sports','file_sports16');
   view_count('data17','filesports','sports');
?></td>
        <td> <button  type="submit" name="submit" class="btn btn-primary"> <strong> Upload </strong> </button></td>
      </tr>

      <td>18</td>
      <td><?php display_image('meentiesname','meenties1620','image18');?></td>
 <td><?php details('meentiesname','meenties1620','name18','name18');?></td>
 <td><?php details('meentiesname','meenties1620','cse18','cse18');?></td>
 <td><?php details('meentiesname','meenties1620','gender18','gender18');?></td>
        <td><div class="file-input">
  ...
  <span class="file-input-name" id="file-name17">No file selected</span>
        ...
        <?php
        upload('data18', 'l1', 'filedownload', 'filename','file_name17');
        view_count('data18', 'filedownload', 'filename');
        ?>
  ...
  <span class="file-input-name" id="file_workshop17">No file selected</span>
        ...
        <?php
        upload('data18','l2','fileworkshop','Workshop','file_workshop17');
        view_count('data18','fileworkshop','Workshop');
        ?>
   </td>
  ...
  <span class="file-input-name" id="file_paper17">No file selected</span>
        ...
        <?php
        upload('data18','l3','filepaper','paper','file_paper17');
        view_count('data18','filepaper','paper');
        ?>
  ...
  <span class="file-input-name" id="file_sports17">No file selected</span>
   ...
   upload('data18','l4','filesports','sports','file_sports17');
   view_count('data18','filesports','sports');
?></td>
        <td> <button  type="submit" name="submit" class="btn btn-primary"> <strong> Upload </strong> </button></td>
      </tr>

      <td>19</td>
      <td><?php display_image('meentiesname','meenties1620','image19');?></td>
 <td><?php details('meentiesname','meenties1620','name19','name19');?></td>
 <td><?php details('meentiesname','meenties1620','cse19','cse19');?></td>
 <td><?php details('meentiesname','meenties1620','gender19','gender19');?></td>
        <td><div class="file-input">
  ...
  <span class="file-input-name" id="file-name18">No file selected</span>
        ...
        <?php
        upload('data19', 'm1', 'filedownload', 'filename','file_name18');
        view_count('data19', 'filedownload', 'filename');
        ?>
  ...
  <span class="file-input-name" id="file_workshop18">No file selected</span>
        ...
        <?php
        upload('data19','m2','fileworkshop','Workshop','file_workshop18');
        view_count('data19','fileworkshop','Workshop');
        ?>
   </td>
  ...
  <span class="file-input-name" id="file_paper18">No file selected</span>
        ...
        <?php
        upload('data19','m3','filepaper','paper','file_paper18');
        view_count('data19','filepaper','paper');
        ?>
  ...
  <span class="file-input-name" id="file_sports18">No file selected</span>
   ...
   upload('data19','m4','filesports','sports','file_sports18');
   view_count('data19','filesports','sports');
?></td>
        <td> <button  type="submit" name="submit" class="btn btn-primary"> <strong> Upload </strong> </button></td>
      </tr>
    ...
    <td><?php display_image('meentiesname','meenties1620','image20');?>
</td>
 <td><?php details('meentiesname','meenties1620','name20','name20');?></td>
 <td><?php details('meentiesname','meenties1620','cse20','cse20');?></td>
 <td><?php details('meentiesname','meenties1620','gender20','gender20');?></td>
        <td><div class="file-input">
  ...
  <span class="file-input-name" id="file-name19">No file selected</span>
        ...
        <?php
        upload('data20', 'n1', 'filedownload', 'filename','file_name19');
        view_count('data20', 'filedownload', 'filename');
        ?>
  ...
  <span class="file-input-name" id="file_workshop19">No file selected</span>
        ...
        <?php
        upload('data20','n2','fileworkshop','Workshop','file_workshop19');
        view_count('data20','fileworkshop','Workshop');
        ?>
   </td>
  ...
  <span class="file-input-name" id="file_paper19">No file selected</span>
        ...
        <?php
        upload('data20','n3','filepaper','paper','file_paper19');
        view_count('data20','filepaper','paper');
        ?>
  ...
  <span class="file-input-name" id="file_sports19">No file selected</span>
   ...
   upload('data20','n4','filesports','sports','file_sports19');
   view_count('data20','filesports','sports');
?></td>
        <td> <button  type="submit" name="submit" class="btn btn-primary"> <strong> Upload </strong> </button></td>
      </tr>
    </tbody>
