...
$gender20 = mysqli_real_escape_string($conn, $_POST["gender20"]);
 ...
 $query1= "INSERT INTO meenties1201 (image1, name1, cse1, gender1, image2, name2, cse2, gender2, image3, name3, cse3, gender3, image4, name4, cse4, gender4, image5, name5, cse5, gender5) VALUES ('$image1', '$name1', '$cse1', '$gender1', '$image2', '$name2', '$cse2', '$gender2', '$image3', '$name3', '$cse3', '$gender3', '$image4', '$name4', '$cse4', '$gender4', '$image5', '$name5', '$cse5', '$gender5')";
 $query2="INSERT INTO meenties10 (image6, name6, cse6, gender6, image7, name7, cse7, gender7, image8, name8, cse8, gender8, image9, name9, cse9, gender9, image10, name10, cse10, gender10) VALUES ('$image6', '$name6', '$cse6', '$gender6', '$image7', '$name7', '$cse7', '$gender7', '$image8', '$name8', '$cse8', '$gender8', '$image9', '$name9', '$cse9', '$gender9', '$image10', '$name10', '$cse10', '$gender10')";
 $query3="INSERT INTO meenties1115 (image11, name11, cse11, gender11, image12, name12, cse12, gender12, image13, name13, cse13, gender13, image14, name14, cse14, gender14, image15, name15, cse15, gender15) VALUES ('$image11', '$name11', '$cse11', '$gender11', '$image12', '$name12', '$cse12', '$gender12', '$image13', '$name13', '$cse13', '$gender13', '$image14', '$name14', '$cse14', '$gender14', '$image15', '$name15', '$cse15', '$gender15')";
 $query4="INSERT INTO meenties1620 (image16, name16, cse16, gender16, image17, name17, cse17, gender17, image18, name18, cse18, gender18, image19, name19, cse19, gender19, image20, name20, cse20, gender20) VALUES ('$image16', '$name16', '$cse16', '$gender16', '$image17', '$name17', '$cse17', '$gender17', '$image18', '$name18', '$cse18', '$gender18', '$image19', '$name19', '$cse19', '$gender19', '$image20', '$name20', '$cse20', '$gender20')";
    ...
    if(mysqli_query($conn, $query2)) {
      ...
      echo "
        <script>
          ...
          window.location.href = 'meenties1.php';
        </script>
      ";
    } else {
...
<html lang="en">
  ...
  <body>
    <section class="container">
      ...
      <form class="form" action="add meenties 1.php" method="post" autocomplete="off" enctype="multipart/form-data">
...
<div class="column">
  <div class="input-box">
    ...
    <input type="text" name="gender19" id = "gender19" placeholder="Enter the gender" required value="">
        ...
        <div class="file-input">
    <input type="file" name="image20" id="image20" accept=".jpg, .jpeg, .png" onchange="updateFileName('image20','file-name20')">
    <label for="image20">Image 20 : </label>
    <label for="image20" class="file-input-label">Select file</label>
    <span class="file-input-name" id="file-name20">No file selected</span>
    </div>
<div class="column">
  <div class="input-box">
    <label for="name20">Name 20: </label>
    <input type="text" name="name20" id = "name20" placeholder="Enter the Staff name" required value=""> </div>
    <div class="input-box">
    <label for="cse20">class 20: </label>
    <input type="text" name="cse20" id = "cse20" placeholder="Enter your class" required value=""> </div>
    <div class="input-box">
    <label for="gender20">gender 20: </label>
    <input type="text" name="gender20" id = "gender20" placeholder="Enter the gender" required value="">
