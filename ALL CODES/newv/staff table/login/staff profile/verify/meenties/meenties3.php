         ...
         <div class = "nav-links" id="navLinks">
            ...
            <ul>
              ...
              <li><a href="http://localhost:8080/project/newup/">Home</a></li>
               ...
               <li><a href="add meenties 3.php">Add Student</a></li>
               <li><a href="chart/chart3.php">Chart</a></li> <!------------staff-->
               <li><a href="meenties mark3.php">NPTEL</a></li>
            </li>
         </ul>
      </div>
        ...
        <section class="table__body">
            <table>
                ...
                <tbody>
                    ...
                    <td>1</td>
                    <td>
<?php display_image('meentiesname','meenties3','image1');?>        
</td>
...
<?php
  upload('data41','image1','filedownload','filename','file_name');
  view_count('data41','filedownload','filename');
?>
</td>
<td><div class="file-input">
  ...
  <span class="file-input-name" id="file_workshop">No file selected</span>
        ...
        upload('data41','image2','fileworkshop','workshop','file_workshop');
        view_count('data41','fileworkshop','workshop');
?>
        </td>
        <td><div class="file-input">
  ...
  <span class="file-input-name" id="file_paper">No file selected</span>
    ...
    <?php
    upload('data41','image3','filepaper','paper','file_paper');
    view_count('data41','filepaper','paper');
    ?>
  ...
  <span class="file-input-name" id="file_sports">No file selected</span>
   ...
   upload('data41','image4','filesports','sports','file_sports');
   view_count('data41','filesports','sports');
?></td>
    <td><button type="submit" name="submit" class="btn btn-primary"> <strong> Upload </strong> </button></td>
    </tr>
    <td contenteditable="true">2</td>
    <td>
    <?php display_image('meentiesname','meenties3','image2','image2');?>
</td>
...
upload('data42','pic1','filedownload','filename','file_intern');
view_count('data42','filedownload','filename');
?>
    </td>
  <td><div class="file-input">
...
upload('data42','pic2','fileworkshop','workshop','file_workshop1');
view_count('data42','fileworkshop','workshop');
...
upload('data42','pic3','filepaper','paper','file_paper1');
view_count('data42','filepaper','paper');
 ...
 <span class="file-input-name" id="file_sports1">No file selected</span>
  ...
  upload('data42','pic4','filesports','sports','file_sports1');
  view_count('data42','filesports','sports');
?></td>
 <td> <button type="submit" name="submit" class="btn btn-primary"> <strong> Upload </strong> </button> </td>
      ...
      <tr>
        <td>3</td>
        <td><?php details('meentiesname','meenties3','image3','image3');?></td>
 ...
 <td><?php details('meentiesname','meenties3','gender3','gender3');?></td>
  ...
  <span class="file-input-name" id="file_name2">No file selected</span>
        ...
        <?php
        upload('data43', 'file1', 'filedownload', 'filename','file_name2');
        view_count('data43', 'filedownload', 'filename');
        ?>
  ...
  <span class="file-input-name" id="file_workshop2">No file selected</span>
        ...
        <?php
        upload('data43','file2','fileworkshop','Workshop','file_workshop2');
        view_count('data43','fileworkshop','Workshop');
        ?>
  ...
  <span class="file-input-name" id="file_paper2">No file selected</span>
        ...
        <?php
        upload('data43','file3','filepaper','paper','file_paper2');
        view_count('data43','filepaper','paper');
  ...
  <span class="file-input-name" id="file_sports2">No file selected</span>
   ...
   upload('data43','file4','filesports','sports','file_sports2');
   view_count('data43','filesports','sports');
?></td>
        <td> <button  type="submit" name="submit" class="btn btn-primary"> <strong> Upload </strong> </button></td>
      ...
      <tr>  <td>4</td>
      <td><?php details('meentiesname','meenties3','image4','image4');?></td>
 ...
 <td><?php details('meentiesname','meenties3','gender4','gender4');?></td>
  ...
  <span class="file-input-name" id="file_name3">No file selected</span>
        ...
        <?php
        upload('data44', 'use1', 'filedownload', 'filename','file_name3');
        view_count('data44', 'filedownload', 'filename');
        ?>
  ...
  <span class="file-input-name" id="file_workshop3">No file selected</span>
        ...
        <?php
        upload('data44','use2','fileworkshop','Workshop','file_workshop33');
        view_count('data44','fileworkshop','Workshop');
        ?>
  ...
  <span class="file-input-name" id="file_paper3">No file selected</span>
        ...
        <?php
        upload('data44','use3','filepaper','paper','file_paper3');
        view_count('data44','filepaper','paper');
        //generate_pie_c2hart('fileworkshop')
        ?>
  ...
  <span class="file-input-name" id="file_sports3">No file selected</span>
   ...
   upload('data44','use4','filesports','sports','file_sports3');
   view_count('data44','filesports','sports');
?></td>
        <td> <button  type="submit" name="submit" class="btn btn-primary"> <strong> Upload </strong> </button></td>
</tr>

<td>5</td>
    <td><?php details('meentiesname','meenties3','image5','image5');?></td>
 ...
 <td><div class="file-input">
  <input type="file" name="a1" id="a1" onchange="updateFileName('a1', 'file-name4')">
  <label for="a1" class="file-input-label">Select file</label>
  <span class="file-input-name" id="file-name4">No file selected</span>
</div>
     
        <?php
        upload('data45', 'a1', 'filedownload', 'filename','file_name4');
        view_count('data45', 'filedownload', 'filename');
        ?>
          ...
          <td><div class="file-input">
  <input type="file" name="a2" id="a2" onchange="updateFileName('a2', 'file_workshop4')">
  <label for="a2" class="file-input-label">Select file</label>
  <span class="file-input-name" id="file_workshop4">No file selected</span>
</div>
        
        
        <?php
        upload('data45','a2','fileworkshop','Workshop','file_workshop4');
        view_count('data45','fileworkshop','Workshop');
        ?>
        ...
        <td><div class="file-input">
  <input type="file" name="a3" id="a3" onchange="updateFileName('a3', 'file_paper4')">
  <label for="a3" class="file-input-label" >Select file</label>
  <span class="file-input-name" id="file_paper4">No file selected</span>
        ...
        <?php
        upload('data45','a3','filepaper','paper','file_paper4');
        view_count('data45','filepaper','paper');
        //generate_pie_chart('fileworkshop')
        ?>
        
        
        </td><td><div class="file-input">
  <input type="file" name="a4" id="a4" onchange="updateFileName('a4', 'file_sports4')">
  <label for="a4" class="file-input-label">Select file</label>
  <span class="file-input-name" id="file_sports4">No file selected</span>
</div>

<?php

   upload('data45','a4','filesports','sports','file_sports4');
   view_count('data45','filesports','sports');
?>
</td>
    <td> <button  type="submit" name="submit" class="btn btn-primary"> <strong> Upload </strong> </button></td>
    </tr>
    <td>6</td>
    <td><?php details('meentiesname','meenties3','image6','image6');?></td>
 ...
 <td><?php details('meentiesname','meenties3','gender6','gender6');?></td>
  ...
  <span class="file-input-name" id="file-name5">No file selected</span>
        ...
        <?php
        upload('data46', 'b1', 'filedownload', 'filename','file_name5');
        view_count('data46', 'filedownload', 'filename');
        ?>
  ...
  <span class="file-input-name" id="file_workshop5">No file selected</span>
        ...
        <?php
        upload('data46','b2','fileworkshop','Workshop','file_workshop5');
        view_count('data46','fileworkshop','Workshop');
        ?>
   </td>
  ...
  <span class="file-input-name" id="file_paper5">No file selected</span>
        ...
        <?php
        upload('data46','b3','filepaper','paper','file_paper5');
        view_count('data46','filepaper','paper');
        ?>
  ...
  <span class="file-input-name" id="file_sports5">No file selected</span>
   ...
   upload('data46','b4','filesports','sports','file_sports5');
   view_count('data46','filesports','sports');
?></td>
        <td> <button  type="submit" name="submit" class="btn btn-primary"> <strong> Upload </strong> </button></td>
      </tr> <td>7</td>
    <td><?php details('meentiesname','meenties3','image7','image7');?></td>
 ...
 <td><?php details('meentiesname','meenties3','gender7','gender7');?></td>
  ...
  <span class="file-input-name" id="file-name6">No file selected</span>
        ...
        <?php
        upload('data47', 'c1', 'filedownload', 'filename','file_name6');
        view_count('data47', 'filedownload', 'filename');
        ?>
  ...
  <span class="file-input-name" id="file_workshop6">No file selected</span>
        ...
        <?php
        upload('data47','c2','fileworkshop','Workshop','file_workshop6');
        view_count('data47','fileworkshop','Workshop');
        ?>
   </td>
  ...
  <span class="file-input-name" id="file_paper6">No file selected</span>
        ...
        <?php
        upload('data47','c3','filepaper','paper','file_paper6');
        view_count('data47','filepaper','paper');
        ?>
  ...
  <span class="file-input-name" id="file_sports6">No file selected</span>
   ...
   upload('data47','c4','filesports','sports','file_sports5');
   view_count('data47','filesports','sports');
?></td>
        <td> <button  type="submit" name="submit" class="btn btn-primary"> <strong> Upload </strong> </button></td>
      </tr>
      <tr>
      <td>8</td>
    <td><?php details('meentiesname','meenties3','image8','image8');?></td>
 ...
 <td><?php details('meentiesname','meenties3','gender8','gender8');?></td>
  ...
  <span class="file-input-name" id="file-name7">No file selected</span>
        ...
        <?php
        upload('data48', 'd1', 'filedownload', 'filename','file_name6');
        view_count('data48', 'filedownload', 'filename');
        ?>
  ...
  <span class="file-input-name" id="file_workshop7">No file selected</span>
        ...
        <?php
        upload('data48','d2','fileworkshop','Workshop','file_workshop6');
        view_count('data48','fileworkshop','Workshop');
        ?>
   </td>
  ...
  <span class="file-input-name" id="file_paper7">No file selected</span>
        ...
        <?php
        upload('data48','d3','filepaper','paper','file_paper7');
        view_count('data48','filepaper','paper');
        ?>
  ...
  <span class="file-input-name" id="file_sports7">No file selected</span>
   ...
   upload('data48','d4','filesports','sports','file_sports7');
   view_count('data48','filesports','sports');
?></td>
        <td> <button  type="submit" name="submit" class="btn btn-primary"> <strong> Upload </strong> </button></td>
      </tr>
      <td>9</td>
    <td><?php details('meentiesname','meenties3','image9','image9');?></td>
 ...
 <td><?php details('meentiesname','meenties3','gender9','gender9');?></td>
  ...
  <span class="file-input-name" id="file-name8">No file selected</span>
        ...
        <?php
        upload('data49', 'e1', 'filedownload', 'filename','file_name8');
        view_count('data49', 'filedownload', 'filename');
        ?>
  ...
  <span class="file-input-name" id="file_workshop8">No file selected</span>
        ...
        <?php
        upload('data49','e2','fileworkshop','Workshop','file_workshop8');
        view_count('data49','fileworkshop','Workshop');
        ?>
   </td>
  ...
  <span class="file-input-name" id="file_paper8">No file selected</span>
        ...
        <?php
        upload('data49','e3','filepaper','paper','file_paper8');
        view_count('data49','filepaper','paper');
        ?>
  ...
  <span class="file-input-name" id="file_sports8">No file selected</span>
   ...
   upload('data49','e4','filesports','sports','file_sports8');
   view_count('data49','filesports','sports');
?></td>
        <td> <button  type="submit" name="submit" class="btn btn-primary"> <strong> Upload </strong> </button></td>
      </tr>
      <td>10</td>
    <td><?php details('meentiesname','meenties3','image10','image10');?></td>
 ...
 <td><?php details('meentiesname','meenties3','gender10','gender10');?></td>
  ...
  <span class="file-input-name" id="file-name9">No file selected</span>
        ...
        <?php
        upload('data50', 'f1', 'filedownload', 'filename','file_name9');
        view_count('data50', 'filedownload', 'filename');
        ?>
  ...
  <span class="file-input-name" id="file_workshop9">No file selected</span>
        ...
        <?php
        upload('data50','f2','fileworkshop','Workshop','file_workshop9');
        view_count('data50','fileworkshop','Workshop');
        ?>
   </td>
  ...
  <span class="file-input-name" id="file_paper9">No file selected</span>
        ...
        <?php
        upload('data50','f3','filepaper','paper','file_paper9');
        view_count('data50','filepaper','paper');
        ?>
  ...
  <span class="file-input-name" id="file_sports9">No file selected</span>
   ...
   upload('data50','f4','filesports','sports','file_sports9');
   view_count('data50','filesports','sports');
?></td>
        <td> <button  type="submit" name="submit" class="btn btn-primary"> <strong> Upload </strong> </button></td>
      </tr>
      <tr>
                    ...
                    <td>11</td>
                    <td>
                    <?php details('meentiesname','meenties3','image11','image11');?>
</td>
...
<?php
  upload('data51','g1','filedownload','filename','file_name10');
  view_count('data51','filedownload','filename');
?>
</td>
<td><div class="file-input">
  ...
  <span class="file-input-name" id="file_workshop10">No file selected</span>
        ...
        upload('data51','g2','fileworkshop','workshop','file_workshop10');
        view_count('data51','fileworkshop','workshop');
?>
        </td>
        <td><div class="file-input">
  ...
  <span class="file-input-name" id="file_paper10">No file selected</span>
    ...
    <?php
    upload('data51','g3','filepaper','paper','file_paper10');
    view_count('data51','filepaper','paper');
    ?>
    </td><td>  <div class="file-input">
  ...
  <span class="file-input-name" id="file_sports10">No file selected</span>
   ...
   upload('data51','g4','filesports','sports','file_sports10');
   view_count('data51','filesports','sports');
?></td>
    <td><button type="submit" name="submit" class="btn btn-primary"> <strong> Upload </strong> </button></td>
    </tr>
    <tr>
      <td>12</td>
    <td>
    <?php details('meentiesname','meenties3','image12','image12');?>
</td>
...
upload('data52','h1','filedownload','filename','file_intern11');
view_count('data52','filedownload','filename');
?>
    </td>
  <td><div class="file-input">
...
upload('data52','h2','fileworkshop','workshop','file_workshop11');
view_count('data52','fileworkshop','workshop');
...
upload('data52','h3','filepaper','paper','file_paper11');
view_count('data52','filepaper','paper');
 ...
 <span class="file-input-name" id="file_sports11">No file selected</span>
  ...
  upload('data52','h4','filesports','sports','file_sports11');
  view_count('data52','filesports','sports');
?></td>
 <td> <button type="submit" name="submit" class="btn btn-primary"> <strong> Upload </strong> </button> </td>
    </tr>
    <td>13</td>
        <td><?php details('meentiesname','meenties3','image13','image13');?></td>
 ...
 <td><?php details('meentiesname','meenties3','gender13','gende13');?></td>
  ...
  <span class="file-input-name" id="file_name12">No file selected</span>
        ...
        <?php
        upload('data53', 'i1', 'filedownload', 'filename','file_name12');
        view_count('data53', 'filedownload', 'filename');
        ?>
  ...
  <span class="file-input-name" id="file_workshop12">No file selected</span>
        ...
        <?php
        upload('data53','i2','fileworkshop','Workshop','file_workshop12');
        view_count('data53','fileworkshop','Workshop');
        ?>
  ...
  <span class="file-input-name" id="file_paper12">No file selected</span>
        ...
        <?php
        upload('data53','i3','filepaper','paper','file_paper12');
        view_count('data53','filepaper','paper');
        //generate_pie_chart('fileworkshop')
        ?>
  ...
  <span class="file-input-name" id="file_sports12">No file selected</span>
   ...
   upload('data53','i4','filesports','sports','file_sports12');
   view_count('data53','filesports','sports');
?></td>
        <td> <button  type="submit" name="submit" class="btn btn-primary"> <strong> Upload </strong> </button></td>
        
      </tr>
      <tr>  <td>14</td>
      <td><?php details('meentiesname','meenties3','image14','image14');?></td>
 ...
 <td><?php details('meentiesname','meenties3','gender14','gender14');?></td>
  ...
  <span class="file-input-name" id="file_name13">No file selected</span>
        ...
        <?php
        upload('data54', 'j1', 'filedownload', 'filename','file_name13');
        view_count('data54', 'filedownload', 'filename');
        ?>
  ...
  <span class="file-input-name" id="file_workshop13">No file selected</span>
        ...
        <?php
        upload('data54','j2','fileworkshop','Workshop','file_workshop13');
        view_count('data54','fileworkshop','Workshop');
        ?>
  ...
  <span class="file-input-name" id="file_paper13">No file selected</span>
        ...
        <?php
        upload('data54','j3','filepaper','paper','file_paper13');
        view_count('data54','filepaper','paper');
        //generate_pie_chart('fileworkshop')
        ?>
  ...
  <span class="file-input-name" id="file_sports13">No file selected</span>
   ...
   upload('data54','j4','filesports','sports','file_sports13');
   view_count('data54','filesports','sports');
?></td>
        <td> <button  type="submit" name="submit" class="btn btn-primary"> <strong> Upload </strong> </button></td>
</tr>

<td>15</td>
    <td><?php details('meentiesname','meenties3','image15','image15');?></td>
 ...
 <td><div class="file-input">
  ...
  <span class="file-input-name" id="file-name14">No file selected</span>
        ...
        <?php
        upload('data55', 'fileed1', 'filedownload', 'filename','file_name14');
        view_count('data55', 'filedownload', 'filename');
        ?>
  ...
  <span class="file-input-name" id="file_workshop14">No file selected</span>
        ...
        <?php
        upload('data55','fileed2','fileworkshop','Workshop','file_workshop14');
        view_count('data55','fileworkshop','Workshop');
        ?>
  ...
  <span class="file-input-name" id="file_paper14">No file selected</span>
        ...
        <?php
        upload('data55','fileed3','filepaper','paper','file_paper14');
        view_count('data55','filepaper','paper');
        //generate_pie_chart('fileworkshop')
        ?>
...
<?php
   ...
   upload('data55','fileed4','filesports','sports','file_sports14');
   view_count('data55','filesports','sports');
?>
</td>
    <td> <button  type="submit" name="submit" class="btn btn-primary"> <strong> Upload </strong> </button></td>
    </tr>
    ...
    <td>16</td>
    <td><?php details('meentiesname','meenties3','image16','image16');?></td>
 ...
 <td><?php details('meentiesname','meenties3','gender16','gender16');?></td>
  ...
  <span class="file-input-name" id="file-name15">No file selected</span>
        ...
        <?php
        upload('data56', 'asd1', 'filedownload', 'filename','file_name15');
        view_count('data56', 'filedownload', 'filename');
        ?>
  ...
  <span class="file-input-name" id="file_workshop15">No file selected</span>
        ...
        <?php
        upload('data56','asd2','fileworkshop','Workshop','file_workshop15');
        view_count('data56','fileworkshop','Workshop');
        ?>
   </td>
  ...
  <span class="file-input-name" id="file_paper15">No file selected</span>
        ...
        <?php
        upload('data56','asd3','filepaper','paper','file_paper15');
        view_count('data56','filepaper','paper');
        ?>
  ...
  <span class="file-input-name" id="file_sports15">No file selected</span>
   ...
   upload('data56','asd4','filesports','sports','file_sports15');
   view_count('data56','filesports','sports');
?></td>
        <td> <button  type="submit" name="submit" class="btn btn-primary"> <strong> Upload </strong> </button></td></tr>
        <tr>
        <td>17</td>
    <td><?php details('meentiesname','meenties3','image17','image17');?></td>
 ...
 <td><?php details('meentiesname','meenties3','gender17','gender17');?></td>
  ...
  <span class="file-input-name" id="file-name16">No file selected</span>
        ...
        <?php
        upload('data57', 'k1', 'filedownload', 'filename','file_name16');
        view_count('data57', 'filedownload', 'filename');
        ?>
  ...
  <span class="file-input-name" id="file_workshop16">No file selected</span>
        ...
        <?php
        upload('data57','k2','fileworkshop','Workshop','file_workshop16');
        view_count('data57','fileworkshop','Workshop');
        ?>
   </td>
  ...
  <span class="file-input-name" id="file_paper16">No file selected</span>
        ...
        <?php
        upload('data57','k3','filepaper','paper','file_paper16');
        view_count('data57','filepaper','paper');
        ?>
  ...
  <span class="file-input-name" id="file_sports16">No file selected</span>
   ...
   upload('data57','k4','filesports','sports','file_sports16');
   view_count('data57','filesports','sports');
?></td>
        <td> <button  type="submit" name="submit" class="btn btn-primary"> <strong> Upload </strong> </button></td>
      </tr>

      <td>18</td>
 <td><?php details('meentiesname','meenties3','image18','image18');?></td>
 ...
 <td><?php details('meentiesname','meenties3','gender18','gender18');?></td>
  ...
  <span class="file-input-name" id="file-name17">No file selected</span>
        ...
        <?php
        upload('data58', 'l1', 'filedownload', 'filename','file_name17');
        view_count('data58', 'filedownload', 'filename');
        ?>
  ...
  <span class="file-input-name" id="file_workshop17">No file selected</span>
        ...
        <?php
        upload('data58','l2','fileworkshop','Workshop','file_workshop17');
        view_count('data58','fileworkshop','Workshop');
        ?>
   </td>
  ...
  <span class="file-input-name" id="file_paper17">No file selected</span>
        ...
        <?php
        upload('data58','l3','filepaper','paper','file_paper17');
        view_count('data58','filepaper','paper');
        ?>
  ...
  <span class="file-input-name" id="file_sports17">No file selected</span>
   ...
   upload('data58','l4','filesports','sports','file_sports17');
   view_count('data58','filesports','sports');
?></td>
        <td> <button  type="submit" name="submit" class="btn btn-primary"> <strong> Upload </strong> </button></td>
      </tr>

      <td>19</td>
 <td><?php details('meentiesname','meenties3','image19','image19');?></td>
 ...
 <td><?php details('meentiesname','meenties3','gender19','gender19');?></td>
  ...
  <span class="file-input-name" id="file-name18">No file selected</span>
        ...
        <?php
        upload('data59', 'm1', 'filedownload', 'filename','file_name18');
        view_count('data59', 'filedownload', 'filename');
        ?>
  ...
  <span class="file-input-name" id="file_workshop18">No file selected</span>
        ...
        <?php
        upload('data59','m2','fileworkshop','Workshop','file_workshop18');
        view_count('data59','fileworkshop','Workshop');
        ?>
   </td>
  ...
  <span class="file-input-name" id="file_paper18">No file selected</span>
        ...
        <?php
        upload('data59','m3','filepaper','paper','file_paper18');
        view_count('data59','filepaper','paper');
        ?>
  ...
  <span class="file-input-name" id="file_sports18">No file selected</span>
   ...
   upload('data59','m4','filesports','sports','file_sports18');
   view_count('data59','filesports','sports');
?></td>
        <td> <button  type="submit" name="submit" class="btn btn-primary"> <strong> Upload </strong> </button></td>
      </tr>
    
      <td>20</td>
 <td><?php display_image('meentiesname','meenties3','image20');?>  </td>
 ...
 <td><?php details('meentiesname','meenties3','gender20','gender20');?></td>
  ...
  <span class="file-input-name" id="file-name19">No file selected</span>
        ...
        <?php
        upload('data60', 'n1', 'filedownload', 'filename','file_name19');
        view_count('data60', 'filedownload', 'filename');
        ?>
  ...
  <span class="file-input-name" id="file_workshop19">No file selected</span>
        ...
        <?php
        upload('data60','n2','fileworkshop','Workshop','file_workshop19');
        view_count('data60','fileworkshop','Workshop');
        ?>
   </td>
  ...
  <span class="file-input-name" id="file_paper19">No file selected</span>
        ...
        <?php
        upload('data60','n3','filepaper','paper','file_paper19');
        view_count('data60','filepaper','paper');
        ?>
  ...
  <span class="file-input-name" id="file_sports19">No file selected</span>
   ...
   upload('data60','n4','filesports','sports','file_sports19');
   view_count('data60','filesports','sports');
?></td>
        <td> <button  type="submit" name="submit" class="btn btn-primary"> <strong> Upload </strong> </button></td>
      </tr>
    </tbody>
