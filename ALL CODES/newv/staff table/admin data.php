...
<head>
    <form action="admin data.php" method="get" enctype="multipart/form-data">
...
<div class="logo">
         ...
         <div class = "nav-links" id="navLinks">
            ...
            <ul>
               ...
               <li><a href="add staff.php" id="add staff.php">Add new staff</a></li>
            </li>
         </ul>
      </div>
...
<form method="get">
  <div class="input-group">
     ...
     <section class="table__body">
            <table>
                <thead>
                    <tr>
                        ...
                        <th> Name </th>
                        <th> Department </th> 
                        <th> Action <span class="icon-arrow">&DownArrow;</span></th>
      ...
      <tr>
        <td><?php echo $i++; ?></td>
        <td> <img src="login/staff profile/verify/meenties/db image and doc/staff image/<?php echo $row["image"]; ?>" width = "100" height="100" title="<?php echo $row['image']; ?>"> </td>
  ...
  <div style="display: inline-block;">
    <form action='delete.php' method='POST'>
      ...
      <button type='submit' name='delete' class="btn btn-danger btn-sm"><i class = "fas fa-trash-alt text-danger"></i></button>
    </form>
  </div>

  <div style="display: inline-block;">
    <a href="login/staff profile/staff profile.php?id=<?= $row['id']; ?>" class="btn btn-info btn-sm" style="margin-left: 10px;"><i class = "fas fa-eye"></i></a>
  </div>
</td>
